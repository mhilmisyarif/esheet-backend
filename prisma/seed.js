...
async function main() {
    ...
    const techUser = await prisma.user.upsert({
        where: { email: 'afif.iskayana@sucofindo.co.id' },
        update: {},
        create: {
            email: 'afif.iskayana@sucofindo.co.id',
    ...
    const enginnerUser = await prisma.user.upsert({
        where: { email: 'ahmad.fasya@sucofindo.co.id' },
        update: {},
        create: {
            email: 'ahmad.fasya@sucofindo.co.id',
    ...
    const adminUser = await prisma.user.upsert({
        where: { email: 'hilmi.syarif@sucofindo.co.id' },
        update: {},
        create: {
            email: 'hilmi.syarif@sucofindo.co.id',
            name: 'Administrator',
            role: 'ADMIN',
